      ...
      <div class="col-lg-8 col-12">
              ...
              <div class="text-start">
                ...
                <div class="row ">
                  ...
                  <div class="col-5 pb-3">
                    <label for="minAverageScore" class="form-label info">Votazione Media</label>
                    <select v-model="minAverageScore" @change="fetchDataProfile" class="form-select select-bg">
                      <option class="select-color" value="0">Mostra tutti</option>
                      <option class="select-color" v-for=" score in [1, 2, 3, 4, 5]" :key="score" :value="score">
                        {{ score }}
                      </option>
                    </select>
                  </div>
                  <div class="col-5 ">
                    <label for="numeroRecensioni" class="form-label info">Recensioni Multiple</label>
                    <select v-model="minReviewCount" @change="fetchDataProfile" class="form-select select-bg">
                      <option class="select-color" value="0">Mostra tutti</option>
                      <option class="select-color" v-for="count in [1, 5, 10]" :key="count" :value="count">
                        {{ count }} recensioni
                      </option>
                    </select>
                  </div>
        ...
        <div class="row scrolling-container">
          <div class="col-md-4" v-for="user in profiles" :key="user.id">
            <div class="card scroll-card bg-card mb-4" v-if="!isNaN(user.average_score) &&
              ...
              <div class="card-body overflow-auto  flex-column p-1">
                ...
                <div class="details " v-if="user.profile">
                  ...
                  <div class="card-text mb-3">
                    ...
                    <p class="info" style="word-wrap: break-word">Description: <span class="description"> {{
                      user.profile.description }}</span></p>
                    <p class="info">
                    ...
                    <router-link class="link" :to="{ name: 'show', params: { id: user.id } }">Dettagli</router-link>
                  </div>
                </div>
              </div>
